...
twoway (line sznclimbers year if peak == 1, color(navy)) (line sznclimbers year if peak !=1, color(navy%20)), xline(2015)
twoway (line avgrisk_s year if peak == 1, color(navy)) (line avgrisk_s year if peak !=1, color(navy%20)), xline(2015)
...
*Earthquake
drop if year == 2015
*Olympics- no climbing in China in spring season
drop if year == 2008
